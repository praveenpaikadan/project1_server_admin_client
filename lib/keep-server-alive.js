...
SEND_REQUEST_EVERY = process.env.KEEP_SERVER_ALIVE_AT_MINS*60*1000 || 10*60*1000

console.log('Keep server alive by sending request at every ',  SEND_REQUEST_EVERY/1000/60 , ' mins')
setInterval(() => {
